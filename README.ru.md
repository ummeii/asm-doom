...
1. Стартовый зал, коридор с дверью по нажатию, большой зал под небом с
   переключателем выхода.
...
3. Лестница из четырёх ступеней и давящий потолок над кислотной нишей.
...
- **Спрайты.** Пистолет, дробовик, зомби, имп, демон и барон перерисованы как следует. Пулемёт,
  ракетница, плазма, BFG и пила — пока на старом, заметно более грубом
  рисунке.
- Нет отдельных кадров атаки и смерти у монстров: используется общий кадр трупа.
- Нет экрана статистики между уровнями.
- Не рисуются полупрозрачные средние текстуры двусторонних линий.
- Нет музыки.
- Мультиплеера нет и не планируется.
