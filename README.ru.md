...
- **Спрайты.** Пистолет, зомби и имп перерисованы как следует. Дробовик,
  пулемёт, ракетница, плазма, BFG, пила, демон и барон — пока на старом,
  заметно более грубом рисунке.
